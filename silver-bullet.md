...
| PATH 9 | REVIEW | Code review — 3 parallel layers with triage + fix |
| PATH 10 | SECURE | Security audit — SENTINEL, gsd-secure-phase, gsd-validate-phase |
| PATH 11 | VERIFY | Verification — gsd-verify-work, verification-before-completion |
| PATH 12 | QUALITY GATE | Quality dimensions — 9-dimension check, dual-mode (design-time + adversarial) |
| PATH 13 | SHIP | Phase shipping — gsd-ship, PR creation |
| PATH 14 | DEBUG | Debugging — systematic-debugging, gsd-debug (dynamic insertion on failure) |
| PATH 15 | DESIGN HANDOFF | Design-to-dev handoff — runs inside PATH 17 only |
| PATH 16 | DOCUMENT | Documentation — gsd-docs-update, engineering:documentation, episodic memory |
| PATH 17 | RELEASE | Milestone release — gsd-audit-uat, gsd-audit-milestone, create-release |
