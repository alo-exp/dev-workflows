...
A Claude Code plugin that enforces a structured 31-step development cycle through six layers of automated compliance enforcement. The plugin tracks skill invocations via hooks and blocks progress when required steps are missing.
