# Silver Bullet — canonical required-deploy skill list (single source of truth)
# Sourced by: stop-check.sh, completion-audit.sh, prompt-reminder.sh
# To add/remove skills: edit ONLY this file. All enforcement hooks pick up changes automatically.
