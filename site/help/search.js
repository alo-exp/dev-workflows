...
var IDX = [
  ...
  { page:'Getting Started', url:'/help/getting-started/', anchor:'install',
    ...
    text:'Install Silver Bullet: /plugin install alo-exp/silver-bullet inside Claude Code. Then initialize a project with /using-silver-bullet. Creates silver-bullet.md CLAUDE.md .silver-bullet.json docs scaffold CI GitHub Actions pipeline. Configures permissions.defaultMode in .claude/settings.local.json to eliminate repeated permission prompts across sessions.' },
  ...
  { page:'Reference', url:'/help/reference/', anchor:'sb-skills',
    ...
    text:'/quality-gates /blast-radius /devops-quality-gates /accessibility-review UI phases only /deploy-checklist /create-release /testing-strategy /tech-debt /documentation /finishing-a-development-branch main branch skipped /incident-response DevOps Incident Fast Path /forensics /using-silver-bullet.' },
  ...
  { page:'Reference', url:'/help/reference/', anchor:'config',
    ...
    text:'project.name src_pattern src_exclude_pattern. semantic_compression enabled context_budget_kb min_file_size_bytes top_chunks_per_file chunk_size_bytes debug. verify_commands for CI gate step 18. all_tracked skills always cross-referenced. workflows default devops paths. silver-bullet.md is the SB-managed enforcement file updated by /using-silver-bullet.' },
