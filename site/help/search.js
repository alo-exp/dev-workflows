...
var IDX = [
  ...
  { page:'DevOps Workflow', url:'/help/devops-workflow/', anchor:'code-review',
    ...
    text:'/code-review peer quality review for IaC changes. superpowers:code-reviewer automated reviewer subagent must return approved TWICE IN A ROW. /requesting-code-review external peer. /receiving-code-review triage accept reject. Same review loop enforcement as dev workflow.' },
