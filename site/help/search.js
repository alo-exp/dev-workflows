...
var IDX = [
  ...
  { page:'DevOps Workflow', url:'/help/devops-workflow/', anchor:'step0',
    ...
    text:'Every DevOps session starts with mode selection before any project work. Interactive default pauses at every phase gate. Autonomous drives start-to-finish logs decisions surfaces blockers at end. Written to /tmp/.silver-bullet-mode defaults to interactive if unreadable.' },
