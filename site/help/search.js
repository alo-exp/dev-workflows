...
var IDX = [
  ...
  { page:'Getting Started', url:'/help/getting-started/', anchor:'what-is-sb',
    ...
    text:'Silver Bullet is a Claude Code plugin combining GSD Superpowers Engineering and Design plugins into two enforced workflows: 19-step software engineering and 23-step DevOps IaC. Hooks enforce every step without relying on Claude self-discipline.' },
  ...
  { page:'Getting Started', url:'/help/getting-started/', anchor:'install',
    ...
    text:'Install Silver Bullet: /plugin install alo-exp/silver-bullet inside Claude Code. Then initialize a project with /using-silver-bullet. Creates silver-bullet.md CLAUDE.md .silver-bullet.json docs scaffold CI GitHub Actions pipeline.' },
  { page:'Getting Started', url:'/help/getting-started/', anchor:'first-project',
    title:'New project vs existing codebase',
    text:'New project: git init or clone then /using-silver-bullet then /gsd:new-project. Existing codebase: run /using-silver-bullet creates silver-bullet.md for enforcement rules and adds reference line to your existing CLAUDE.md preserving your instructions.' },
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'superpowers',
    ...
    text:'Superpowers provides design and review skills: /brainstorming /system-design /design-system /ux-copy /requesting-code-review /receiving-code-review superpowers:code-reviewer automated reviewer subagent.' },
  ...
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'code-review',
    title:'Steps 8–9 — Code review',
    text:'/requesting-code-review dispatches superpowers:code-reviewer for peer quality review security performance correctness readability. Must return approved TWICE IN A ROW two consecutive passes. Self-limiting loop ends naturally when two clean passes produced. /receiving-code-review triage accept reject.' },
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'post-review',
    title:'Steps 10–11 — Post-review execution (conditional)',
    text:'Only runs if review items were accepted in Step 9. Step 10 /gsd:plan-phase creates plan for accepted review items same rigor as Step 5. Step 11 /gsd:execute-phase implements review-driven plan with atomic commits same model as Step 6. Otherwise loop to next phase.' },
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'finalization',
    title:'Steps 12–15 — Finalization',
    text:'/testing-strategy test pyramid coverage goals tooling. /tech-debt identify categorize prioritize technical debt docs/tech-debt.md required skill invocation. /documentation update README PRD-Overview Architecture Testing CICD KNOWLEDGE CHANGELOG. README must be updated here before release step 19. /finishing-a-development-branch rebase cleanup.' },
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'deployment',
    title:'Step 16 — CI/CD pipeline gate',
  ...
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'deploy-check',
    title:'Step 17 — Deploy checklist — /deploy-checklist',
  ...
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'release',
    title:'Step 19 — Release — /create-release',
  ...
  { page:'DevOps Workflow', url:'/help/devops-workflow/', anchor:'execute',
    ...
    text:'Wave-based execution applies to lowest environment only. Higher environments promoted in steps 13-14 after all phases complete. Plan dry-run confirm before apply. Verify resource health after apply. Atomic commit per task.' },
  ...
  { page:'DevOps Workflow', url:'/help/devops-workflow/', anchor:'code-review',
    title:'Steps 9–10 — Code review (DevOps)',
    text:'/requesting-code-review dispatches superpowers:code-reviewer for IaC peer quality review. Must return approved TWICE IN A ROW. /receiving-code-review triage accept reject. Same review loop enforcement as dev workflow.' },
  ...
  { page:'DevOps Workflow', url:'/help/devops-workflow/', anchor:'finalization',
    title:'Steps 15–18 — Finalization with Runbooks',
  ...
  { page:'DevOps Workflow', url:'/help/devops-workflow/', anchor:'deployment',
    title:'Steps 19–21 — Production deployment gate',
  ...
  { page:'DevOps Workflow', url:'/help/devops-workflow/', anchor:'ship-release',
    title:'Steps 22–23 — Ship and Release',
  ...
  { page:'Troubleshooting', url:'/help/troubleshooting/', anchor:'hooks',
    ...
    text:'jq command not found install jq. Permission denied on hook scripts chmod +x hooks. Hooks not firing run /using-silver-bullet to create config. Compliance status wrong progress delete ~/.claude/.silver-bullet/state stale state file.' },
  ...
  { page:'Troubleshooting', url:'/help/troubleshooting/', anchor:'enforcement',
    ...
    text:'HARD STOP planning incomplete run /quality-gates before editing source. COMPLETION BLOCKED workflow incomplete check missing steps run /gsd:next. Trivial change bypass touch ~/.claude/.silver-bullet/trivial for typos. DevOps yaml json files never trivial.' },
  ...
  { page:'Reference', url:'/help/reference/', anchor:'sp-skills',
    ...
    text:'/brainstorming /system-design /design-system /ux-copy /requesting-code-review /receiving-code-review superpowers:code-reviewer. Used for design and review only never for execution.' },
  ...
  { page:'Reference', url:'/help/reference/', anchor:'config',
    ...
    text:'project.name src_pattern src_exclude_pattern. semantic_compression enabled context_budget_kb min_file_size_bytes top_chunks_per_file chunk_size_bytes debug. verify_commands for CI gate step 17. all_tracked skills always cross-referenced. workflows default devops paths. silver-bullet.md is the SB-managed enforcement file updated by /using-silver-bullet.' },
