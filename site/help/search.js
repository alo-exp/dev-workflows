...
var IDX = [
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'review-analytics',
    ...
    text:'v0.16.0 review analytics. Every review round emits structured metrics to JSON Lines file automatically. Each record captures artifact type review depth round number pass/fail result finding categories and timestamp. Run /silver-review-stats for summary reports: pass rates by artifact type rounds to clean pass finding categories by artifact type.' },
  { page:'Reference', url:'/help/reference/', anchor:'spec-skills',
