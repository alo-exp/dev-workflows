...
var IDX = [
  ...
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'review-loop',
    ...
    text:'Every review loop must iterate until reviewer returns approved TWICE IN A ROW. A single clean pass is not sufficient. Never stop because issues are minor or close enough. Maximum 6 iterations before surfacing to user. Must reach maximum not stop early. Two consecutive clean passes required.' },
