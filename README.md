...
**Current version: v0.6.0** — double-pass review loop enforcement (✅ Approved twice in a row), blocking CI gate (hard stop on failure), expanded CI stack detection (8 new stacks), and critical `/create-release` skill rename fix.
